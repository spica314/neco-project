...
use crate::{
    path_table2::PathTable2,
    rename_defs2::{DefDecoration, DefId},
};
...
pub struct RenameUseContext {
    ...
    path_table: PathTable2,
    use_count: usize,
}

impl RenameUseContext {
    pub fn new(resolver: Resolver<DefId>, path_table: PathTable2) -> Self {
        Self {
            resolver,
            path_table,
            use_count: 0,
...
mod test {
    ...
    use crate::{
        path_table2::construct_path_table_syn_file, rename_defs2::RenameDefContext, rename_defs2::*,
    };
